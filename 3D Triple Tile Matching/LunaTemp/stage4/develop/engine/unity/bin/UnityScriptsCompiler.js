...
if ( TRACE ) { TRACE( "ProjectGamePlay.MapGenerate#GenerateMap", this ); }
                    ...
                    for (var i = 0; i < levelData.numOfTiles; i = (i + 1) | 0) {
                        ...
                        var id = tileDataController.GetRandomTileId();
                        var tile = UnityEngine.Object.Instantiate$2(UnityEngine.GameObject, tilePrefab, levelData.tileData.getItem(i).tilePosition.$clone(), pc.Quat.IDENTITY.clone()).GetComponent(ProjectGamePlay.Tile);
...
if ( TRACE ) { TRACE( "ProjectGamePlay.Tile#OnTileCollect", this ); }
                ...
                $t = Bridge.getEnumerator(this._listTileBehind);
                try {
                    while ($t.moveNext()) {
                        var tile = $t.Current;
